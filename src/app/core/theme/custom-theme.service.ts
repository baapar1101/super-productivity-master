...
const HUMA_REF: CustomThemeRef = { kind: 'builtin', id: 'huma' };
 ...
 * everyone lands on Huma, the product's house design.
 *
 ...
 *
 * Exported so tests can exercise both branches directly.
 */
...
export const BUILT_IN_THEMES: CustomTheme[] = [
  ...
  },
  {
    ...
    name: 'هُما (Huma)',
    kind: 'builtin',
    url: 'assets/themes/huma.css',
    // Glassmorphism over deep ink surfaces — needs a dark canvas.
    requiredMode: 'dark',
  },
  {
    id: 'lines',
