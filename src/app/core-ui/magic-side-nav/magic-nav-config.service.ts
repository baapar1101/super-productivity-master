...
export class MagicNavConfigService {
  ...
  readonly navConfig = computed<NavConfig>(() => ({
    items: [
      ...
      // The Donate entry and the Help menu are intentionally omitted from the
      // sidebar. Both remain reachable by route (/donate) and the help links
      // live in Settings — keeping the sidebar to navigation only.
